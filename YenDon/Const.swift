...
struct Const {
    ...
    static let COUNTRIES = [
        ...
        Country.create(USD, image: #imageLiteral(resourceName: "United-States"), symbol: "US$", minAmount: 1.0),
        Country.create(AUD, image: #imageLiteral(resourceName: "Australia"), symbol: "AU$", minAmount: 1.0),
