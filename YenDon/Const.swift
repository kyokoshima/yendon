...
struct Const {
    ...
    static let COUNTRIES = [
        Country.create(VND, image: #imageLiteral(resourceName: "Vietnam"), symbol: "₫", minAmount: 100.0, minDigit: 0.0),
        Country.create(JPY, image: #imageLiteral(resourceName: "Japan"), symbol: "¥", minAmount: 1.0, minDigit: 0.0),
        Country.create(USD, image: #imageLiteral(resourceName: "United-States"), symbol: "US$", minAmount: 1.0, minDigit: 2.0),
        Country.create(AUD, image: #imageLiteral(resourceName: "Australia"), symbol: "AU$", minAmount: 1.0, minDigit: 2.0),
